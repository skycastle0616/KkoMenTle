...
scenes     이 말이 등장할 법한 장면 3개. 각각 한 줄(20자 내외). 스포 강도 '중'.
           · 눈에 보이는 것만 적어라. 추상어·개념어로 설명하지 마라.
           · 직업 이름을 대지 마라 (사기꾼·마술사·도둑 같은 것). 그 일을 업으로 삼는
             사람을 부르는 순간 정답이 딸려 나온다. 그 순간의 그림만 적어라.
             나쁜 예 (정답이 '속이다'): "사기꾼이 거짓말로 타인의 돈을 편취하려 할 때"
                      — 직업과 뜻풀이 낱말이 정답을 그대로 부른다.
             좋은 예 (정답이 '거울'): "화장실에서 넥타이를 고쳐 매는 순간"
