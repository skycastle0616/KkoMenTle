...
fairness (0.0~1.0)
  ...
  0.6~0.8  표준어이긴 하나 현대 한국어에서 다른 말에 거의 밀려났다. 두 갈래다.
           ① 더 흔한 유의어가 사실상 대체했다.
              예: '네거리' — '사거리'가 자리를 가져갔다.
           ② 어근형이 파생형을 밀어냈는데 그 파생형이 정답이다.
              예: '가득히' — 사람들은 '가득' 이나 '가득하다'를 쓴다.
              뜻은 같고 형태만 덜 쓰이는 것이라 크게 깎지 마라. 0.7~0.8 이면 된다.
           ★ ②의 신호는 목록에서 바로 보인다 — 정답의 어근형이 상위권에 독립해
             앉아 있으면 그렇다. (정답 '가득히' 인데 '가득'이 2위 52.16으로 따로 있다)
